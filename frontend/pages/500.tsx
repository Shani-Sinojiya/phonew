...
const error500 = () => {
  function AnimationImageSVG(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
      ...
      >
        <style>
          {
            "@-webkit-keyframes flicker-4{0%,31.98%,32.82%,34.98%,35.72%,36.98%,37.62%,67.98%,68.42%,95.98%,96.72%,98.98%,99.62%,to{opacity:1}32%,32.8%,35%,35.7%,37%,37.6%,68%,68.4%,96%,96.7%,99%,99.6%{opacity:0}}@keyframes flicker-4{0%,31.98%,32.82%,34.98%,35.72%,36.98%,37.62%,67.98%,68.42%,95.98%,96.72%,98.98%,99.62%,to{opacity:1}32%,32.8%,35%,35.7%,37%,37.6%,68%,68.4%,96%,96.7%,99%,99.6%{opacity:0}}@-webkit-keyframes vibrate-1{0%,to{-webkit-transform:translate(0);transform:translate(0)}20%{-webkit-transform:translate(-2px,2px);transform:translate(-2px,2px)}40%{-webkit-transform:translate(-2px,-2px);transform:translate(-2px,-2px)}60%{-webkit-transform:translate(2px,2px);transform:translate(2px,2px)}80%{-webkit-transform:translate(2px,-2px);transform:translate(2px,-2px)}}@keyframes vibrate-1{0%,to{-webkit-transform:translate(0);transform:translate(0)}20%{-webkit-transform:translate(-2px,2px);transform:translate(-2px,2px)}40%{-webkit-transform:translate(-2px,-2px);transform:translate(-2px,-2px)}60%{-webkit-transform:translate(2px,2px);transform:translate(2px,2px)}80%{-webkit-transform:translate(2px,-2px);transform:translate(2px,-2px)}}@-webkit-keyframes wobble-ver-right{0%,to{-webkit-transform:translateY(0) rotate(0);transform:translateY(0) rotate(0);-webkit-transform-origin:50% 50%;transform-origin:50% 50%}15%{-webkit-transform:translateY(-30px) rotate(6deg);transform:translateY(-30px) rotate(6deg)}30%{-webkit-transform:translateY(15px) rotate(-6deg);transform:translateY(15px) rotate(-6deg)}45%{-webkit-transform:translateY(-15px) rotate(3.6deg);transform:translateY(-15px) rotate(3.6deg)}60%{-webkit-transform:translateY(9px) rotate(-2.4deg);transform:translateY(9px) rotate(-2.4deg)}75%{-webkit-transform:translateY(-6px) rotate(1.2deg);transform:translateY(-6px) rotate(1.2deg)}}@keyframes sad{0%{transform:rotateX(0deg) rotateY(0deg)}to{transform:rotateX(10deg) rotateY(5deg)}}@keyframes leftright{0%{transform:rotateZ(0deg)}to{transform:rotateZ(-15deg)}}.fio,.tomada{-webkit-animation:vibrate-1 3s linear infinite both;animation:vibrate-1 3s linear infinite both}"
          }
        </style>
        <defs>
          <path
          ...
          <path
            id="prefix__i"
            d="M.39 2.037c0 1.08.88 1.956 1.966 1.956a1.963 1.963 0 001.968-1.956c0-1.08-.88-1.956-1.968-1.956A1.961 1.961 0 00.39 2.037z"
          />
          <path
            id="prefix__k"
            d="M.39 2.466c0 1.08.88 1.956 1.966 1.956a1.961 1.961 0 001.968-1.956A1.96 1.96 0 002.356.512 1.96 1.96 0 00.39 2.466z"
          />
          <path
            id="prefix__m"
            d="M1.963.022C.893.022.026.898.026 1.977c0 1.08.867 1.956 1.937 1.956H16.45a1.946 1.946 0 001.935-1.956A1.946 1.946 0 0016.45.022H1.963z"
          />
          <path
            id="prefix__o"
            d="M5.214 5.34c-.85 3.38 1.072 5.145 5.14 11.15L.464 55.893l44.419 11.492 9.888-39.401c6.384-3.286 8.919-3.909 9.77-7.295.793-3.159-1.093-6.383-4.206-7.189L12.294 1.071a5.696 5.696 0 00-1.437-.185c-2.598 0-4.972 1.783-5.643 4.453z"
          />
          <path
            id="prefix__q"
            d="M5 6.465c-1.055 4.052 1.213 6.332 4.666 11.2l-9.2 35.38 2.075.52 9.442-36.306c-3.886-5.53-5.717-7.165-4.909-10.276.758-2.91 3.791-4.675 6.762-3.933l45.868 11.453c2.971.742 4.772 3.714 4.015 6.624-.81 3.118-3.222 3.687-9.328 6.72L44.95 64.154l2.076.518 9.2-35.38c5.404-2.654 8.514-3.59 9.57-7.646 1.047-4.032-1.447-8.15-5.563-9.177L14.365 1.016a7.818 7.818 0 00-1.9-.234C9.025.782 5.885 3.056 5 6.465z"
          />
          <path
            id="prefix__s"
          ...
          <path
            id="prefix__y"
            d="M.102 2.593A2.386 2.386 0 002.26 5.177a2.376 2.376 0 002.591-2.138A2.382 2.382 0 002.47.445 2.376 2.376 0 00.102 2.593z"
          />
          <path
            id="prefix__A"
            d="M.007 2.613a2.381 2.381 0 002.155 2.582 2.375 2.375 0 002.593-2.138A2.379 2.379 0 002.374.464c-1.216 0-2.253.92-2.367 2.149z"
          />
          <path
            id="prefix__C"
          ...
          <path
            id="prefix__E"
            d="M8.699 4.235L2.878 2.667c-.528-.144-1.074.182-1.219.725-.143.547.167 1.102.693 1.243l5.821 1.572-1.076 4.048-5.821-1.572a1 1 0 00-1.217.729c-.145.544.164 1.1.692 1.24l5.822 1.573-.9 3.377 7.313 1.973c4.037 1.088 8.21-1.407 9.32-5.573.753-2.832-.102-5.71-1.996-7.605a7.403 7.403 0 00-3.307-1.914L9.69.511 8.7 4.235z"
          />
          <path
            id="prefix__G"
            d="M1.203 6.693a7.827 7.827 0 005.536 9.596l7.57 2.024 1.534-5.714 2.531-9.428-7.569-2.025a7.849 7.849 0 00-9.602 5.548z"
          />
        </defs>
        <g fill="none" fillRule="evenodd">
          ...
          <path
            ...
            style={{
              WebkitAnimation: "vibrate-1 3s linear infinite both",
          ...
          <g className="full-torradeira">
            ...
            >
              ...
              <g transform="translate(344.301 196.242)">
                ...
                <path
                  fill="#633"
                  d="M-4.153-6.995l16.451 3.198-3.191 16.424-16.453-3.198z"
                  mask="url(#prefix__z)"
                  style={{
              ...
              <g transform="translate(361.087 196.242)">
                ...
                <path
                  fill="#633"
                  d="M-4.248-6.976l16.451 3.198-3.192 16.423-16.452-3.197z"
                  mask="url(#prefix__B)"
                  style={{
                    animation: "sad 2s alternate infinite",
                    transformOrigin: "center",
              ...
              <g transform="translate(350.495 205.834)">
                ...
                <path
                  fill="#633"
                  d="M-3.14-7.546l21.133 4.108L14.8 12.985-6.333 8.878z"
                  mask="url(#prefix__D)"
                  style={{
                    animation: "sad 2s alternate infinite",
                    transformOrigin: "center",
          ...
          <path
            d="M278.964 208.006l2.957-2.949m-12.046 1.632l-1.998-3.669m7.196 2.733l.479-3.309m-11.709 28.064l-3.043 2.862m12.088-1.28l1.891 3.724m-7.113-2.94l-.575 3.293"
            stroke="#fdba55"
            strokeLinecap="round"
            strokeWidth={1.8}
          />
          <g transform="translate(272.561 214.226)">
            ...
            <path
              className="tomada"
              fill="#2D3F5B"
              d="M10.383-14.007L34.351 9.962 12.875 31.438l-23.97-23.969z"
              mask="url(#prefix__F)"
            />
          </g>
          <g transform="translate(246.184 207.033)">
            ...
            <path
              className="tomada"
              fill="#2D3F5B"
              d="M10.807-12.875L32.391 8.709l-21.598 21.6-21.586-21.585z"
              mask="url(#prefix__H)"
            />
          </g>
        </g>
  ...
  return (
    <main className="flex items-center text-center justify-center flex-col my-0 mx-auto w-auto max-w-[560px] min-h-screen">
      <Head>
        <title>500 - Woops! Something went wrong {":("}</title>
      </Head>
      <AnimationImageSVG />
      <h1 className="mb-4 max-w-[529px] font-stretch-normal text-error500 text-4xl font-Nunito font-bold leading-normal not-italic tracking-normal">
        Woops! <br />
